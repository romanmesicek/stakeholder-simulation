...
### Möglichkeiten während der Verhandlungen

- **Briefe schreiben:** Schicken Sie Forderungen, Angebote oder Protestbriefe an andere Gruppen
- **Delegationen entsenden:** Schicken Sie 1-2 Personen zu Gesprächen mit anderen Gruppen
- **Flugblätter verteilen:** Informieren Sie die "Öffentlichkeit" über Ihre Position
- **Plakate erstellen:** Für Demonstrationen oder öffentliche Aufmerksamkeit
- **Presseerklärungen:** Veröffentlichen Sie Ihre Sichtweise

**Tipp:** Dokumentieren Sie alle Vereinbarungen schriftlich!
...
3. **Offene Diskussion** (restliche Zeit)
   ...
   - Versuch einer gemeinsamen Lösung
...
## Tipps für ein erfolgreiches Planspiel

### Vorbereitung

- Lesen Sie alle Materialien gründlich
- Verstehen Sie nicht nur Ihre eigene Rolle, sondern auch die Interessen der anderen Gruppen
- Entwickeln Sie eine klare Strategie mit Maximal- und Minimalzielen

### Während der Verhandlungen

- **Zuhören** ist genauso wichtig wie Argumentieren
- Suchen Sie nach **Win-Win-Lösungen** statt Nullsummenspielen
- Seien Sie bereit, **Kompromisse** einzugehen
- Nutzen Sie **schriftliche Vereinbarungen** um Ergebnisse festzuhalten
- Bilden Sie **Allianzen** mit Gruppen, die ähnliche Interessen haben

### Bürgerkonferenz

- Bereiten Sie ein klares, strukturiertes Statement vor
- Beziehen Sie sich auf Fakten und Gesetze
- Präsentieren Sie konstruktive Vorschläge, nicht nur Forderungen
- Reagieren Sie auf die Statements der anderen Gruppen
